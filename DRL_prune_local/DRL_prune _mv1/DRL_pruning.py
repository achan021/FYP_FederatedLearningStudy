...
import pandas as pd
import cv2
import hook_cifarnet_static_dynamic_agg_exp as hook_cifarnet
...
with torch.cuda.device(0):
    ...
    base_net = hook_cifarnet.MobileNetV1()

    net = hook_cifarnet.GatedMv1(base_net)
    ...
    pruning_net.init_basenet(input_shape=(3, 224, 224))
...
model_name = 'mobilenetV1_budget_{}_dpratio_{}'.format(arg['budget'], arg['dynamic_prune_ratio'])
#save the
